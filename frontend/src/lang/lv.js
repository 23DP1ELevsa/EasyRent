export default {
  ...
  profile: {
    ...
    reservations: { title: 'Rezervācijas', subtitle: 'Pārskatiet aktīvās un neapmaksātās rezervācijas.', providerSubtitle: 'Pārskatiet, kuri transportlīdzekļi ir rezervēti, uz cik ilgu laiku un vai tie ir apmaksāti.', unpaidAlert: 'Jums ir {count} neapmaksāta(s) rezervācija(s).', activeTitle: 'Aktīvās rezervācijas', unpaidTitle: 'Neapmaksātās rezervācijas', historyTitle: 'Rezervāciju vēsture', providerActiveTitle: 'Aizņemtie transportlīdzekļi', providerPendingTitle: 'Rezervācijas, kas gaida apmaksu', providerHistoryTitle: 'Transportlīdzekļu rezervāciju vēsture', paid: 'Apmaksāts', unpaidStatus: 'Neapmaksāts', historyDone: 'Pabeigta', bookedAt: 'Rezervēts', payNow: 'Apmaksāt tagad', cancelReservation: 'Atcelt rezervāciju', loading: 'Ielādē...', empty: 'Vēl nav rezervāciju.', noActive: 'Nav aktīvu rezervāciju.', noUnpaid: 'Nav neapmaksātu rezervāciju.', noHistory: 'Nav iepriekšējo rezervāciju.', noProviderActive: 'Pašlaik nav aizņemtu transportlīdzekļu.', noProviderPending: 'Nav rezervāciju, kas gaida apmaksu.', noProviderHistory: 'Nav iepriekšējo transportlīdzekļu rezervāciju.' },
    vehicleFields: { type: 'Transporta veids', gearbox: 'Ātrumkārba', fuel: 'Degvielas veids', registrationNumber: 'Reģistrācijas numurs' },
  ...
  map: {
    ...
    filterLabels: { search: 'Meklēt pēc nosaukuma vai pilsētas', provider: 'Pakalpojumu sniedzējs', type: 'Transporta veids', gearbox: 'Ātrumkārba', fuel: 'Degvielas veids', minPrice: 'Cena no (€)', maxPrice: 'Cena līdz (€)', onlyAvailable: 'Rādīt tikai pieejamo' },
    vehicleFields: { type: 'Transporta veids', brand: 'Marka', model: 'Modelis', gearbox: 'Ātrumkārba', fuel: 'Degvielas veids', dailyPrice: 'Cena (€ / diena)', status: 'Statuss', registrationNumber: 'Reģistrācijas numurs' },
